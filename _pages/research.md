...
[//]: from: https://talk.jekyllrb.com/t/how-to-link-from-md-page-to-other-page/6067/4
[//]: jekyll3: [Link to a page]({{ site.baseurl }}{% link test_sub.md %})
[//]: jekyll4: [Link to a page]({% link test_sub.md %})
[//]: absolute: [Link to a page]({{ site.url }}{{ site.baseurl }}{% link test_sub.md %})

## The Impact of Remote Work on Women's Labor Market Share ([*Job Market Paper*]({{site.url}}{% link /files/JMP.pdf %}))
